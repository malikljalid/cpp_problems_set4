...
short int vacationDays(stDate Start, stDate End)
{
    int DaysDifference = 0;

    while (Date1IsEqualToDate2(Start, End) == false)
    {
...
int main(void)
{
    ...
    VacationDate2 = initDate(readNumber("day"), readNumber("month"), readNumber("year"));

    printDayOfWeek(VacationDate1, "Vacation Start: ");
    printDayOfWeek(VacationDate2, "Vacation End : ");

    std::cout << "Actual Vacation Days : " << vacationDays(VacationDate1, VacationDate2) << std::endl;
