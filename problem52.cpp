...
short int daysUntilEndOfYear(stDate Date)
{
    stDate endOfMonthDate = Date;

    endOfMonthDate.Month  = 12;
    endOfMonthDate.Day    = getMonthDays(endOfMonthDate.Month, endOfMonthDate.Year);
...
int main(void)
{
    ...
    std::cout << daysUntilEndOfYear(Date) << " Days until end of Year...\n";
