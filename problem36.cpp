...
stDate decreaseDateByXWeeks(stDate Date, short int WeeksToSub)
{
    while (WeeksToSub--)
...
int main(void)
{
    ...
    printDate(Date);
    printDate(decreaseDateByXWeeks(Date, readNumber("Please enter number of weeks you want to sub ? : ")));
